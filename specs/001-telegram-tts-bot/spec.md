...
- Сообщение без текста (стикер, фото, голос) — бот сообщает, что озвучивать нечего.
...
- **FR-002**: Бот MUST принимать только текстовые сообщения или пересланные тексты; при отсутствии текста MUST отвечать, что озвучивать нечего.
